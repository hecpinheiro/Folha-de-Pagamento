...
public class PagamentoService {
  ...
  public List<HistoricoDeSalario> calcularFolha(
    String dia,
    ...
    for(Empregado empregado : empregados) {
      ...
      if(empregado instanceof Horista) {
        pagamento = this.calcularFolhaHorista(data, empregado, cartaoDePontos, taxasDeServico);
      } else if(empregado instanceof Comissionado) {
        pagamento = this.calcularFolhaComissionado(data, empregado, vendas, taxasDeServico);
      } else if(empregado instanceof Assalariado) {
        pagamento = this.calcularFolhaAssalariado(data, empregado, taxasDeServico);
      }
